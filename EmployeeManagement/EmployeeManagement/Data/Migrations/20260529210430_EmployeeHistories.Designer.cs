...
namespace EmployeeManagement.Data.Migrations
{
    ...
    [Migration("20260529210430_EmployeeHistories")]
    partial class EmployeeHistories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeManagement.Models.ApprovalEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeManagement.Models.ApprovalsUserMatrix", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ApprovalsUserMatrixs");
                });

            modelBuilder.Entity("EmployeeManagement.Models.Audit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeManagement.Models.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeManagement.Models.CompanyInformation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeManagement.Models.Employee", b =>
                {
                    ...
                    b.Property<double?>("LeaveOutstandingBalance")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("EmployeeManagement.Models.EmployeeContract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeManagement.Models.EmployeeHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("EffectiveDtae")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("EmployeeManagement.Models.EmployeeNextOfKin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeManagement.Models.FixedAsset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeManagement.Models.LeaveAdjustmentEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeManagement.Models.RoleProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeManagement.Models.SystemProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeManagement.Models.WorkFlowUserGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeManagement.Models.WorkFlowUserGroupMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeManagement.Models.ApprovalEntry", b =>
                {
                    ...
                    b.HasOne("EmployeeManagement.Models.SystemCodeDetail", "DocumentType")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeManagement.Models.ApprovalsUserMatrix", b =>
                {
                    b.HasOne("EmployeeManagement.Models.ApplicationUser", "CreatedBy")
                        .WithMany()
                    ...
                    b.HasOne("EmployeeManagement.Models.ApplicationUser", "ModifiedBy")
                        .WithMany()
                    ...
                    b.HasOne("EmployeeManagement.Models.WorkFlowUserGroup", "WorkflowUserGroup")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeManagement.Models.Employee", b =>
                {
                    ...
                    b.HasOne("EmployeeManagement.Models.SystemCodeDetail", "Disability")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeManagement.Models.EmployeeContract", b =>
                {
                    b.HasOne("EmployeeManagement.Models.SystemCodeDetail", "ContractType")
                        .WithMany()
                    ...
                    b.HasOne("EmployeeManagement.Models.SystemCodeDetail", "CurrencyType")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeManagement.Models.EmployeeHistory", b =>
                {
                    b.HasOne("EmployeeManagement.Models.SystemCodeDetail", "ChangeType")
                        .WithMany()
                    ...
                    b.HasOne("EmployeeManagement.Models.Department", "NewDepartment")
                        .WithMany()
                        .HasForeignKey("NewDepartmentId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("EmployeeManagement.Models.Designation", "NewDesignation")
                        .WithMany()
                        .HasForeignKey("NewDesignationId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("EmployeeManagement.Models.Department", "OldDepartment")
                        .WithMany()
                        .HasForeignKey("OldDepartmentId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("EmployeeManagement.Models.Designation", "OldDesignation")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeManagement.Models.EmployeeNextOfKin", b =>
                {
                    ...
                    b.HasOne("EmployeeManagement.Models.SystemCodeDetail", "Relationship")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeManagement.Models.FixedAsset", b =>
                {
                    b.HasOne("EmployeeManagement.Models.SystemCodeDetail", "Category")
                        .WithMany()
                    ...
                    b.HasOne("EmployeeManagement.Models.Employee", "ResponsibleEmployee")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeManagement.Models.LeaveAdjustmentEntry", b =>
                {
                    b.HasOne("EmployeeManagement.Models.SystemCodeDetail", "AdjustmentType")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeManagement.Models.LeaveApplication", b =>
                {
                    ...
                    b.HasOne("EmployeeManagement.Models.SystemCodeDetail", "Duration")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeManagement.Models.RoleProfile", b =>
                {
                    ...
                    b.HasOne("EmployeeManagement.Models.SystemProfile", "Task")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeManagement.Models.SystemProfile", b =>
                {
                    ...
                    b.HasOne("EmployeeManagement.Models.SystemProfile", "Profile")
                        .WithMany("Children")
